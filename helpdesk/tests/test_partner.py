...
class TestPartner(TransactionCase):
    def setUp(self):
        ...
        self.parent_id.helpdesk_ticket_ids = (
            0,
            0,
            {"name": f"Ticket of parent ", "priority": "2", "closed": True},
        )
        self.child_id_1.helpdesk_ticket_ids = (
            0,
            0,
            {
        ...
        self.child_id_2.helpdesk_ticket_ids = (
            0,
            0,
            {
        ...
        self.child_id_3.helpdesk_ticket_ids = (
            0,
            0,
            {
    ...
    def test_ticket_count():
        self.assertEqual(parent_id.helpdesk_ticket_count, 100)
